                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-borderless mb-0">
                                                    <tbody>
                                                        <tr>
                                                            <th class="ps-0" scope="row">Full Name : <span style="color: #800000;">{{Auth::user()->first_name}}</span></th>
                                                            {{-- <td class="text-muted"></td> --}}
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">Role : <span style="color: #800000;">{{Auth::user()->roles[0]->name}}</span></th>
                                                            {{-- <td class="text-muted"></td> --}}
                                                        </tr>
                                                    </tbody>
                                                </table>
