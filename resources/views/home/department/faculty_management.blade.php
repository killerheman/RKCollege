@extends('home.includes.layout', ['title' => 'Faculty of Management'])
    ...
    <div class="page-wrapper">
        ...
        <div class="page-content">
            <div class="row page-row">
                @include('home.sidebar.department', ['active' => 4])

                <div class="team-wrapper col-md-10 col-sm-7">
                    <h2 class="no-margin-top has-divider text-highlight">Faculty of Management</h2>
